...
const pillButtonVariants = cva(
  "focus-visible:ring-ring/50 inline-flex shrink-0 items-center justify-center rounded-full font-medium whitespace-nowrap transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        primary: 'btn-pill-shadow-primary bg-foreground text-background hover:bg-foreground',
        accent: 'btn-pill-shadow-accent bg-accent text-accent-foreground hover:bg-accent',
        ghost:
          'border-foreground text-foreground hover:bg-foreground hover:text-background border-[1.5px] bg-transparent',
      },
      ...
      size: {
        ...
        default: 'h-11 gap-2 px-6 text-[15px] leading-none tracking-[-0.005em] has-[>svg]:px-5',
